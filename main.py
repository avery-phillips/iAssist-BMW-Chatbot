...
background: #f7fafc;
/* The 'color' property here sets the default text color for the chat message container. */
/* While often sufficient, nested elements might override it. */
color: #000000; /* Set a default dark color for the container */
margin-left: 0;
margin-right: auto;
...
/* This is the most crucial part for ensuring assistant text is black. */
/* It targets the markdown content directly within the assistant message. */
[data-testid="chat-message-assistant"] .stMarkdown {
color: #000000 !important; /* Force text inside stMarkdown to be black */
}

/* Further ensure all direct text elements within the assistant message are black */
/* This handles cases where text might be in <p>, <span>, etc., generated by markdown */
